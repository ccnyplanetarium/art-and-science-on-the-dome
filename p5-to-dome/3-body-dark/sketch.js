...
function spawn3Bodies() {
  for (i = 0;i<3;i++)
 {
   ...
   orbiters.push(new Orbiter(createVector(random(width/4,3*width/4),random(.4*height,.8*height)),createVector(xvels[i],yvels[i]),createVector(0,0),masses[i], colors[i]));
